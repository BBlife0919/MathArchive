...
HWPX = "/Users/youngwoolee/Downloads/수업자료/탑반 교재/[SSEN 공통수학2]04.도형의 이동.hwpx"
OUT_DIR = "/Users/youngwoolee/Downloads/수업자료/탑반 교재"
KP_PDF = "/tmp/dohyeong_kernel_v2.pdf"
COMBINED = f"{OUT_DIR}/도형의이동_KERNEL+WORKBOOK_합본.pdf"
...
SMALL_DIR = "/tmp/dohyeong_images_small_v2"
...
pdf_bytes = generate_book_pdf(
    rows, title="도형의 이동", subtitle="공통수학2 KERNEL POINT",
    include_source=False, overrides=overrides, logo_path=None,
    kicker_mark=None, kicker_text=None,
    divider_meta_top="공통수학2 · 도형의 이동 · KERNEL POINT",
    divider_footer_title="공통수학2 · 도형의 이동 · KERNEL POINT",
    ...
    cover_footer_sub="공통수학2 · 도형의 이동 · KERNEL POINT",
    page_running_left="공통수학2 도형의 이동 · KERNEL POINT",
