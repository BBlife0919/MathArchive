...
CHAR_IMG = Path("/Users/youngwoolee/.claude/image-cache/8316f005-83f3-4cde-953f-c612daf4bb81/193.png")
...
def make_cover():
    ...
    try:
        ...
        f_big = font(1400, "cafe24")
        text_centered(draw, (W // 2, H // 2 - 50), "②", f_big, DEEP_PINK)
    ...
    text_centered(draw, (W // 2, title_y), "명문고2 대수 기말 ②", f_title, INK)

    # 아래 부제
    sub_y = H - 620
    f_sub = font(96, "cafe24")
    text_centered(draw, (W // 2, sub_y), "대수 · 20문항", f_sub, INK)
